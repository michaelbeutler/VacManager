...
CREATE TABLE IF NOT EXISTS `vac_manager`.`vacation`(
    ...
    CONSTRAINT `fk_vacation_user2` FOREIGN KEY(`user_id_status`) REFERENCES `vac_manager`.`user`(`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE INDEX `fk_vacation_user2_idx` ON
    `vac_manager`.`vacation`(`user_id_status` ASC);
